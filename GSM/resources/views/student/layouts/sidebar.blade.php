    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('student.actions.create') }}"><i class="bi bi-plus-circle"></i>
                    Log Action</a>
                <a class="collapse-item" href="{{ route('student.actions.index') }}"><i class="bi bi-list-check"></i> My
                    Actions</a>
